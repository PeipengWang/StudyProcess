...
![image-20240815111140397](./assets/image-20240815111140397-1723691502344-3.png)
...
![image-20240815111212015](./assets/image-20240815111212015-1723691533335-5.png)

总体来说，这两种方案都会创建多个线程，这些线程都会参与到消息的消费过程中，但各自的思路是不一样的。

这两种方案孰优孰劣呢？应该说是各有千秋。我总结了一下这两种方案的优缺点，我们先来看看下面这张表格。

![image-20240815111234764](./assets/image-20240815111234764-1723691556272-7.png)
